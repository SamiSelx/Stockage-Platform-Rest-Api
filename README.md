# Storage File Platform

## Project Overview:
This project is an API for Storage File Platform
...
1. Clone the repository: `git clone https://github.com/SamiSelx/Stockage-Platform-Rest-Api`
2. Navigate to the project directory: `cd Stockage-Platform-Rest-Api`
