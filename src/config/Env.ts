...
/**
 * @description The domain name of the platform. If 'DOMAIN' is not set, it defaults to 'stockage.app'
 * @default "stockage.app"
 * 
 */
export const DOMAIN = CheckEnv("DOMAIN", "stockage.app");

/**
 * @description The URL of the backend. If 'BACK_URL' is not set, it defaults to 'http://localhost:PORT' in development mode and 'https://stockage.app' in production mode.
 ...
 * @default "yassersellal14@gmail.com"
 */
export const DEV_Email = CheckEnv("DEV_Email", "yassersellal14@gmail.com");
...
export const PROJECT_Name = CheckEnv("PROJECT_Name", "Stocakge Cloud Platform");
